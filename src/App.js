            ...
            <div className="survey-container intro-container">
              ...
              <div className="research-sections">
                ...
                <section>
                  ...
                  <p style={{ textAlign: 'left' }}>이 연구는 연세대학교 간호대학에서 주관하고, 연구진행도 연세대학교 간호대학생을 대상으로 이루어집니다. 한 그룹당 4-6 명, 총 세 그룹, 12-18 명이 참여할 예정이고, 연구 기간은 세브란스병원 연구심의의원회 승인 후부터 2025 년 10 월 31 일까지입니다.</p>
                </section>
                ...
                <section>
                  ...
                  <p style={{ textAlign: 'left' }}>귀하가 설문조사에 참여하여 협조해주신 것에 대한 감사의 마음으로 10,000원 상당의 모바일 쿠폰을 드립니다.</p>
                </section>
                      ...
                      <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '10px' }}>
                        <tbody>
                          <tr>
                            ...
                            <td style={{ border: '1px solid black', padding: '8px' }}>성명 또는 이니셜, 전화번호, 성별, 학년, 누적 학업 성취도</td>
                          </tr>
                          <tr>
...
연구종료 후 3 년간 보관 후 컴퓨터의 포멧을 통해 폐기될 것입니다.</p>
      ...
      case 'personalInfo':
        return (
          <div className="App">
            <div className="survey-container">
              <div className="personal-info-form" style={{ maxWidth: '600px', margin: '0 auto', padding: '30px' }}>
                <h2 style={{ textAlign: 'center', marginBottom: '30px', color: '#333' }}>개인정보 입력</h2>
